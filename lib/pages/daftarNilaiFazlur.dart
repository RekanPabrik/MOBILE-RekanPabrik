...
import 'package:rekanpabrik/models/daftarNilai.dart';
import 'package:rekanpabrik/utils/dataDummyNilai.dart';
                  ...
                  IconButton(
                    icon: Container(
                      ...
                      padding: const EdgeInsets.all(
                          8.0), // Padding untuk menempatkan icon di tengah
                      child: const Icon(
...
class _NilaiCardState extends State<NilaiCard> {
      ...
      child: Column(
        children: [
          ...
          if (_isExpanded) ...[
            ...
            Text(
              widget.nilai.deskripsi, // Misalnya, menampilkan deskripsi
  ...
  // Widget untuk menampilkan Aspek dengan latar belakang biru
